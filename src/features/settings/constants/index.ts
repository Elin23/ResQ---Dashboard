...
export const adminStatusLabels: Record<AdminAccountStatus, string> = {
  ACTIVE: 'نشط',
  SUSPENDED: 'معلق',
  INVITED: 'دعوة معلقة',
  DISABLED: 'معطل',
...
export const lookupLabels: Record<LookupType, string> = {
  REPORT_REJECTION_REASONS: 'أسباب رفض البلاغ',
  ADOPTION_REJECTION_REASONS: 'أسباب رفض طلب التبني',
...
export const emergencyCategoryLabels = {
  VETERINARY: 'بيطري',
  RESCUE: 'إنقاذ',
  OTHER: 'أخرى',
} as const;