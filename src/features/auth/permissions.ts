...
const explicitLabels: Partial<Record<Permission, string>> = {
  ...
  'map.create': 'إضافة أماكن يدوية إلى الخريطة',
  'map.review': 'مراجعة طلبات الظهور على الخريطة',
  'map.update': 'تحديث حالة الأماكن على الخريطة',
  'map.delete': 'حذف الأماكن اليدوية من الخريطة',
