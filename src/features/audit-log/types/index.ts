...
export const auditActions = [
  ...
  'USER_BLOCKED',
  'USER_UNBLOCKED',
  'FEEDING_POINT_APPROVED',
  'FEEDING_POINT_REJECTED',
  'FEEDING_POINT_DEACTIVATED',
  'FEEDING_POINT_REFILL_VERIFIED',
  'FEEDING_POINT_REFILL_REJECTED',
  ...
  // Actions emitted by the current DashboardBackend audit service.
  'CREATE',
  'UPDATE',
  'STATUS_UPDATE',
  'APPROVE',
...
// Shape used when a new audit entry is recorded.
