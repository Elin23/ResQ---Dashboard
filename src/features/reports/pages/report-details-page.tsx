      ...
      <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-muted-foreground/75">
            ...
            <span>
              نُشر {formatReportDate(report.createdAt)}
            </span>

            <span>·</span>

            <span>
              آخر تحديث {formatReportDate(report.updatedAt)}
            </span>
          </div>
      ...
      <div className="grid items-start gap-4 xl:grid-cols-[minmax(0,1fr)_20rem]">
        <Card className="overflow-hidden rounded-xl border border-border/45 bg-white p-0 shadow-none">
          <section className="p-5">
            <ReportOverview details={details} />
          </section>

          <div className="border-t border-border/40" />

          <section className="p-5">
            <ReportMediaSection details={details} />
          </section>

          <div className="border-t border-border/40" />

          <section className="p-5">
            <ReportLocationSection details={details} />
          </section>

          <div className="border-t border-border/40" />

          <section className="p-5">
            <ReportTimelineSection details={details} />
          </section>
        </Card>
        ...
        <aside className="xl:sticky xl:top-20">
          <Card className="rounded-xl border border-border/45 bg-white p-4 shadow-none">
            <div>
              ...
              {/* Status changes normally come from the assigned organization. */}
            ...
            <div>
              ...
              <p dir="ltr" className="mt-1 text-[13px] font-medium text-foreground">
                {report.id}
              </p>
            </div>
          </Card>
