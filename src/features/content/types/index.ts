...
export interface SuccessStory{id:string;title:string;slug:string;summary:string;content:string;coverImageUrl?:string;coverAltText?:string;gallery?:ContentMedia[];reportId?:string;missionId?:string;organizationId?:string;status:ContentStatus;author:ContentAuthor;publishedAt?:string;scheduledAt?:string;createdAt:string;updatedAt:string}
...
export interface EditorialInput{title:string;slug:string;summary:string;content:string;coverImageUrl?:string;coverAltText?:string;category?:ArticleCategory;tags:string[];scheduledAt?:string;metaTitle?:string;metaDescription?:string;reportId?:string;missionId?:string;organizationId?:string;audience?:Array<'ALL'|'USERS'|'ORGANIZATIONS'>}
