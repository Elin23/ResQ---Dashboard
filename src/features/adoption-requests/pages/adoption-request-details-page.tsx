...
import { AdoptionApplicationsSection, AdoptionInternalNotesCard, AdoptionMainDetails, AdoptionTimelineSection, PublisherPanel } from '../components/adoption-details-sections';
