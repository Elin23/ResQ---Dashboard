...
import { Check, ChevronDown, ChevronLeft, ChevronRight, Download, FileSpreadsheet, FileText, Search, X, type LucideIcon,} from 'lucide-react';

import { forwardRef, useEffect, useRef, useState, type ButtonHTMLAttributes, type HTMLAttributes,
  type InputHTMLAttributes, type ReactNode, type TextareaHTMLAttributes,} from 'react';
...
export function FilterBar({
  ...
  return (
    <div className="resq-filter-bar flex flex-col gap-2 rounded-xl border border-border/45 bg-white p-2.5 shadow-none sm:flex-row sm:flex-wrap sm:items-center">
      {children}
    </div>
  );
}
