  ...
  const icon = useMemo(
    () =>
      L.divIcon({
        ...
        html: `<span class="resq-map-marker resq-map-marker--${markerTone}${
          selected ? ' resq-map-marker--selected' : ''
      ...
      <Popup>
        ...
        >
          <p className="text-xs text-muted-foreground">
            {entityTypeLabels[entity.type] ?? 'مكان'}
          </p>

          <p className="font-bold">
            {safeDisplayText(entity.title, 'مكان بلا اسم')}
          </p>

          <p className="mt-1 text-xs">
            {safeDisplayText(entity.governorate, 'موقع غير محدد')}
