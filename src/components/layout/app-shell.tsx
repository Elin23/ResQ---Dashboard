...
export function AppShell() {
  ...
  // Reset the page scroll when the route changes.
  useLayoutEffect(() => {
    ...
    <div className="relative flex h-dvh overflow-hidden bg-background">
      ...
      <div className="relative flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main
          ref={mainRef}
          id="main-content"
          className="resq-scroll-region relative min-h-0 flex-1 overflow-y-auto"
        >
          <div
            className="pointer-events-none absolute inset-x-0 top-0 h-48 overflow-hidden sm:h-56"
            aria-hidden="true"
          >
